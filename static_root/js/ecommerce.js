        ...
        productForm.submit(function(event){
          ...
          $.ajax({
            ...
            success: function(data){
              ...
              if (data.added){
                $("span").html("In Cart <button type='submit' class='btn btn-link'>Remove?</button>");
              }
              else{
                $("span").html("<button type='submit' class='btn btn-success'>Add to cart</button>");
              }
